...
ggsurvplot(kmf.all, palette = "#2E9FDF")
```

KM Age
```{r km.age, echo=FALSE}

km.age = survfit(s.df~strata(df$Age.Strata),type="kaplan-meier", data = df)
ggsurvplot(km.age, palette = c("darkcyan","darkgoldenrod3","darkorange3"))
```
