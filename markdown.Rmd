...
Here is the survival curve for all groups within our dataset. We see that a majority of our censored values have very short survival times. This is given to our limited interval study time of a single year. 

#### KM Age
```{r km.age, fig.align='center', echo=FALSE}
