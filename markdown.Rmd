...
rownames(km.as) = c("All","Age:<55", "Age: 55-65", "P.Eff: Absent","P.Eff: Present", "WMS: < 14", "WMS: \u2265 14","Fractal Shortening: < 0.2", "Fractal Shortening: \u2265 0.2")
...
haz.plots[[2]] = ggsurvplot(km.age, 
           ...
           xlab="Time to Death (Months)",
           legend.title = "Groups",
           legend.labs = c("< 55 Year","55 - 65 Years"))
...
arrange_ggsurvplots(haz.plots, print=TRUE, ncol=2, nrow=3)
